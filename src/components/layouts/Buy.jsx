	...
	return (
		<div className="flex flex-col justify-center items-center w-full absolute bottom-0 bg-gray-300/90 md:bg-transparent rounded-tl-3xl rounded-tr-3xl ">
			...
			<div className="bg-[#E0A435] w-full md:bg-transparent flex justify-evenly p-1 md:gap-8 md:mb-3">
				<button className="bg-[#E0A435] text-black font-semibold px-8 py-2 rounded-full w-7/12 sm:w-fit md:w-full">Add to cart</button>

				<button className="bg-black hover:bg-gray-900 text-white font-semibold px-8 py-2 rounded-lg md:rounded-full w-fit md:w-full">Buy Now</button>
			</div>
		</div>
	);
}
